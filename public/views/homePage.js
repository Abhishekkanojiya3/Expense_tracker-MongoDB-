...
async function getAllExpenses() {
    ...
    try {
        ...
        const res = await axios.get(
            "http://localhost:3000/expense/getAllExpenses/1", { headers: { Authorization: token } }
        );
...
async function paginationBtn(e) {
    try {
        ...
        const token = localStorage.getItem("token");
        const res = await axios.get(
            `http://localhost:3000/expense/getAllExpenses/${pageNo}`, { headers: { Authorization: token } }
        );
...
async function deleteExpense(e) {
    try {
        ...
        if (e.target.classList.contains("delete")) {
            ...
            const res = await axios.get(
                `http://localhost:3000/expense/deleteExpense/${id}`, { headers: { Authorization: token } }
            );
            window.location.reload();
        }
    } catch {
...
async function editExpense(e) {
    try {
        ...
        if (e.target.classList.contains("edit")) {
            ...
            const res = await axios.get(
                "http://localhost:3000/expense/getAllExpenses", { headers: { Authorization: token } }
            );
...
async function buyPremium(e) {
    const token = localStorage.getItem("token");
    const res = await axios.get(
        "http://localhost:3000/purchase/premiumMembership", { headers: { Authorization: token } }
    );
    var options = {
...
async function isPremiumUser() {
    ...
    if (res.data.isPremiumUser) {
        ...
        leaderboardLink.setAttribute("/public/leaderboard.html");
        reportsLink.setAttribute("/public/reports.html");
